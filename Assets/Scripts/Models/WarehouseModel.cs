...
namespace DroneBase.Models
{
    public class WarehouseModel : IWarehouseModel
    {
        ...
        public WarehouseModel(EntityType type, List<ResourcesContainer> resources, Vector3 interactivePoint = default, Vector3 position = default, Quaternion rotation = default)
        {
